...
export const metadata = {
  ...
  openGraph: {
    ...
    url: "/blog/boosting-engagement-web-design",
    siteName: "Wired-In Labs",
    images: [
      {
        url: process.env.NEXT_PUBLIC_CDN_PUBLIC_LINK+"images/blog4-cover.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: [process.env.NEXT_PUBLIC_CDN_PUBLIC_LINK+"images/blog4-cover.jpg"],
  },
};
